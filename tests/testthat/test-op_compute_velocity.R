...
test_that("op_compute_velocity calculates velocity correctly", {
  ...
  # Test: Compute velocity with FPS provided
  ...
  # Test: Compute velocity with video duration provided
  ...
  # Test: Merge 'x' and 'y' columns to calculate Euclidean velocity
  ...
  expect_false(any(grepl("^c", names(velocity_data_merged))), info = "'c' columns were not removed")
